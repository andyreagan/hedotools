...
x[e]>re[0]&&x[e]<re[1]&&(r=!1),r||(t[e]=0)}return t},xe=function(){i=i.map(function(t,e){return(e+1+". ").concat(0==s[e]?t.concat("-↓"):1==s[e]?t.concat("+↓"):2==s[e]?t.concat("-↑"):t.concat("+↑"))}),ne&&(c=c.map(function(t,e){return(e+1+". ").concat(0==s[e]?t.concat("-↓"):1==s[e]?t.concat("+↓"):2==s[e]?t.concat("-↑"):t.concat("+↑"))}))},me=function(t,e,r,n){var a=this
...
for(var p=indexer2d(r,i[0],d.y0,d.y1,d.x0,d.x1),x=0;x<e.sprite.length&&(!e.sprite[x]||!p[x]);x++);if(x===e.sprite.length)return t.push(d),!0}})(c,f,h)
