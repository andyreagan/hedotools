...
return s}var hedotools=hedotools||{},classColor=d3.scale.quantize().range([0,1,2,3,4,5,6]).domain([50,1])
...
!function(){d3.urllib={encoder:function(){function t(t){return{current:n}}function e(){GET={},query=window.location.search.substring(1).split("&")
